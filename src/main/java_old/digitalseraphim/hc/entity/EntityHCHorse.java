...
public class EntityHCHorse extends EntityHorse {
	...
	private static final IAttribute endurance = (new RangedAttribute(
			"horse.endurance", 0.7D, 0.0D, 2.0D)).setDescription("Endurance")
			.setShouldWatch(true);
	private static final IAttribute tiredness = (new RangedAttribute(
			"horse.tiredness", 0.7D, 0.0D, 2.0D)).setDescription("Tiredness")
			.setShouldWatch(true);
	private static final IAttribute strength = (new RangedAttribute(
